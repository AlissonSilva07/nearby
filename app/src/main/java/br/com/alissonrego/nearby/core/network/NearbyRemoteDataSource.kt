package br.com.alissonrego.nearby.core.network

import br.com.alissonrego.nearby.core.network.KtorHttpClient.httpClientAndroid
import br.com.alissonrego.nearby.data.model.Coupon
import br.com.alissonrego.nearby.data.model.Market
import br.com.alissonrego.nearby.data.model.MarketDetails
...
object NearbyRemoteDataSource {
    ...
    private const val LOCAL_HOST_PHYSICAL_BASE_URL = "http://192.168.0.13:3333"
